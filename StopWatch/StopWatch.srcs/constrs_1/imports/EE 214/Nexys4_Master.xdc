...
set_property PACKAGE_PIN R2 [get_ports {En_Indi}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {En_Indi}]
#Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = LED15
set_property PACKAGE_PIN P2 [get_ports {press}]					
...
#set_property PACKAGE_PIN R10 [get_ports inc]						
